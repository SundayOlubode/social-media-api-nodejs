...
postRouter.route("/like-post").get(isAuthenticatedUser, likeAndUnlikePost);

postRouter.route("/get-posts").get(isAuthenticatedUser, getFollowingPosts);

postRouter.route("/add-comment").post(isAuthenticatedUser, addComment);

postRouter.route("/get-comments").get(isAuthenticatedUser, getAllComments);

postRouter
  .route("/like-comment")
  .get(isAuthenticatedUser, likeAndUnlikeComment);

postRouter.route("/delete-comment").delete(isAuthenticatedUser, deleteComment);
